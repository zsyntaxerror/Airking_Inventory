...
const routePrefetchMap = {
  ...
  '/admin/purchase-orders': () => import('../pages/PORecommendation'),
...
const AdminLayout = ({ children }) => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ['/admin/dashboard', '/admin/inventory', '/admin/purchase-orders',
       '/admin/items', '/admin/transactions', '/admin/receivings'].forEach(prefetchRoute);
    }, 1000);
  ...
  const adminMenuSections = [
    {
      ...
      items: [
        ...
        { name: 'Branch & Warehouse', path: '/admin/branches', icon: 'branch' },
        { name: 'Roles & Permissions', path: '/admin/roles', icon: 'roles' },
    ...
    },
    {
      label: 'PROCUREMENT',
      items: [
        { name: 'Product Management', path: '/admin/items', icon: 'items' },
        { name: 'Suppliers', path: '/admin/suppliers', icon: 'supplier' },
        { name: 'Purchase Orders', path: '/admin/purchase-orders', icon: 'po' },
        { name: 'Receiving of Items', path: '/admin/receivings', icon: 'receiving' },
      ],
    },
    {
      label: 'INVENTORY',
      items: [
        { name: 'Inventory (Stock)', path: '/admin/inventory', icon: 'inventory' },
        { name: 'Stock Transfer', path: '/admin/transfers', icon: 'transfer' },
        { name: 'Issuance (Internal)', path: '/admin/issuances', icon: 'issuance' },
        { name: 'Adjustment / Correction', path: '/admin/adjustments', icon: 'adjustment' },
      ],
    },
    {
      ...
      items: [
        ...
        { name: 'Sales', path: '/admin/transactions', icon: 'transactions' },
        { name: 'Delivery Receipts', path: '/admin/delivery-receipts', icon: 'delivery' },
        { name: 'Purchase Returns', path: '/admin/purchase-returns', icon: 'return' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Profit / Loss', path: '/admin/profit-loss', icon: 'profitloss' },
      ],
    },
  ];
      ...
      <div className="content-wrapper">
        ...
        <header className="top-header">
          ...
          <div className="header-actions">
            <button type="button" className="notification-btn" onClick={() => navigate('/admin/notifications')} aria-label="Notifications">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
              </svg>
