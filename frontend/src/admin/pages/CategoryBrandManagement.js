...
const CategoryBrandManagement = () => {
  ...
  const CategoryIcon = ({ name }) => {
    ...
    return (
      <div className={`cb-icon cb-icon-${type}`}>
        {type === 'ac' && (
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M2 12h20M4.93 4.93l14.14 14.14M19.07 4.93L4.93 19.07"/></svg>
        )}
        {type === 'tv' && (
        ...
        {type === 'wm' && (
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="2" width="18" height="20" rx="2"/><circle cx="12" cy="14" r="5"/><circle cx="12" cy="14" r="2"/><line x1="8" y1="5" x2="8" y2="5"/><line x1="12" y1="5" x2="12" y2="5"/></svg>
        )}
        {type === 'ref' && (
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="4" y1="12" x2="20" y2="12"/><line x1="9" y1="7" x2="9" y2="9"/><line x1="9" y1="15" x2="9" y2="17"/></svg>
        )}
        {type === 'small' && (
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v10l4.24 4.24"/><circle cx="12" cy="12" r="10"/></svg>
        )}
        {type === 'default' && (
            ...
            <div className="cb-two-cols">
              ...
              <section className="cb-section">
                ...
                <ul className="cb-card-list">
                  ...
                  {brands.map((b) => (
                    <li key={b.brand_id} className="cb-card cb-card-brand">
                      <div className="cb-icon cb-icon-brand">
                      ...
                      <div className="cb-card-body">
                        ...
                        <div className="cb-card-meta">
                          {b.items_count ?? 0} items • {formatMoney(b.total_value)}
                        </div>
                      </div>
                      <div className="cb-card-actions">
                        <button type="button" className="cb-btn-edit" onClick={() => openEditBrand(b)}>Edit</button>
                        <button type="button" className="cb-btn-archive" onClick={() => handleArchiveBrand(b)}>Archive</button>
                      </div>
                    </li>
                  ))}
                </ul>
                  ...
                  <tbody>
                    {performance.map((row, i) => (
                      <tr key={row.category || i}>
                        ...
                        <td className="cb-value">{formatMoney(row.total_value)}</td>
