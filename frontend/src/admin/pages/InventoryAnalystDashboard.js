  ...
  return (
    <AdminLayout>
      ...
      <div className="rd-quick-links">
        {[
          { label: 'Restocking Recommendations', path: '/admin/purchase-orders', color: ACCENT },
      ...
      <div className="rd-table-card">
        <div className="rd-table-header">
          ...
          <button className="rd-table-action" style={{ color: ACCENT }} onClick={() => navigate('/admin/purchase-orders')}>
