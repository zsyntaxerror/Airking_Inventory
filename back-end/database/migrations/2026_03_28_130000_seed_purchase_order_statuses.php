...
return new class extends Migration
{
    public function up(): void
    {
        ...
        foreach (
            [
                ['status_name' => 'Pending Approval', 'status_category' => 'purchase_order'],
                ['status_name' => 'Authorized', 'status_category' => 'purchase_order'],
            ] as $row
        ) {
    ...
    public function down(): void
    {
        ...
        DB::table('status_lookup')
            ...
            ->whereIn('status_name', ['Pending Approval', 'Authorized'])
            ->delete();
    }
};
